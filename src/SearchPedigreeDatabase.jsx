...
import { Box, Typography, Input, Button, CircularProgress, IconButton } from '@mui/joy'; // CssVarsProvider removed
...
const SearchPedigreeDatabase = ({ setView }) => {
  ...
  return (
    <PageLayout maxWidth="600px">
      ...
      <Typography variant="body2" sx={{ marginTop: 2, marginBottom: 3, textAlign: 'center' }}>
      ...
      {searchResults && (
        <>
          ...
          <Box sx={{ display: 'flex', overflowX: 'auto', marginTop: 2, width: '100%' }}>
              ...
              return (
                <Box key={resultKey} sx={{ marginBottom: 2 }}>
                  <Typography
                    ...
                    ref={(el) => { categoryRefs.current[resultKey] = el; }}
                  >
                    {heading}:
                  </Typography>
